...
function Workspace() {
  return html`<div class="qa-workspace">
      ...
      <div class="free-plan-widget">
        <span class="plan-widget-tag"><img class="icon icon-checkmark" src="https://unity-poc--express--adobecom.hlx.page/express/icons/checkmark.svg" alt="checkmark" />Free to use</span>
        <span class="plan-widget-tag"><img class="icon icon-checkmark" src="https://unity-poc--express--adobecom.hlx.page/express/icons/checkmark.svg" alt="checkmark" />No credit card required</span>
      </div>
      <div class="pb-30px">Explore more Quick Actions. <strong>It's free.</strong></div>
      <div class="explore">
        <a href='/'><img src='/unitylibs/blocks/fqa-unity//resize.svg' />Resize image</a>
        <a href='/'><img src='./crop.svg' />Crop image</a>
        <a href='/'><img src='./convert.svg' />Convert to PNG</a>
        <a href='/'><img src='./convert.svg' />Convert to SVG</a>
        <a href='/'><img src='./convert.svg' />Convert to JPG</a>
      </div>
    </div>
  </div>`;
}
