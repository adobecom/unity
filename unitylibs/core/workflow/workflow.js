...
class WfInitiator {
  ...
  getEnabledFeatures() {
    ...
    const verbWidget = this.el.closest('.section')?.querySelector('.verb-widget, .study-marquee, .verb-marquee, .verb-redesign-test, .verb-dropzone, .verb-widget-client-upload');
    if (verbWidget) {
