...
export default class UnityWidget {
  ...
  async genDropdown(ph) {
    ...
    const titleCon = createTag('li', { class: 'drop-title-con', tabindex: '-1' });
    ...
    dd.append(createTag('li', { class: 'drop-sep', tabindex: '-1' }));
    dd.append(this.createFooter(ph));
    return dd;
  }

  createFooter(ph) {
    const footer = createTag('li', { class: 'drop-footer', tabindex: '-1' });
