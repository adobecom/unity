...
export default class ActionBinder {
  ...
  static LIMITS_MAP = {
    ...
    'gen-presentation-v2': ['single', 'allowed-filetypes-presentation-report', 'page-limit-600', 'max-filesize-100-mb'],
    'interactive-report': ['single', 'allowed-filetypes-presentation-report', 'page-limit-600', 'max-filesize-100-mb'],
