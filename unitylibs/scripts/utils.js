...
export const unityConfig = (() => {
  ...
  const cfg = {
    ...
    stage: {
      apiEndPoint: 'https://unity-dev-ue1.adobe.io/api/v1',
      connectorApiEndPoint: 'https://unity-dev-ue1.adobe.io/api/v1/asset/connector',
      pageConfigEndPoint: 'https://cdn-unity.dev-ue1.adobe.com/api/v1/pageConfig',
      env: 'stage',
      ...commoncfg,
    },
  };
