export default class CombinePdf {
  constructor(page, nth = 0) {
    this.page = page;
    // Combine-pdf widget locators
    this.section = this.page.locator('.section').nth(nth);
    this.combinePdf = this.page.locator('.merge-pdf.unity-enabled').nth(nth);
    this.dropZone = this.combinePdf.locator('#drop-zone');
    this.verbRow = this.combinePdf.locator('.verb-row').nth(0);
    ...
    this.verbImage = this.combinePdf.locator('.verb-image');
