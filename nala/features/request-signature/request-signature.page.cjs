export default class RequestSignature {
  constructor(page, nth = 0) {
    ...
    this.requestSignature = this.page.locator('.sendforsignature.unity-enabled').nth(nth);
    this.dropZone = this.requestSignature.locator('#drop-zone');
    this.verbRow = this.requestSignature.locator('.verb-row').nth(0);
    ...
    this.verbImage = this.requestSignature.locator('.verb-image');
