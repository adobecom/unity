...
import { features } from './study-with-acrobat.spec.cjs';
import StudyWithAcrobat from './study-with-acrobat.page.cjs';

const pdfFilePath = path.resolve(__dirname, '../../assets/1-PDF-study-with-acrobat.pdf');
