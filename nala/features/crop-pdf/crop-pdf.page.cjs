export default class CropPdf {
  constructor(page, nth = 0) {
    this.page = page;
    // crop-pdf widget locators
    this.section = this.page.locator('.section').nth(nth);
    this.cropPdf = this.page.locator('.crop-pages.unity-enabled').nth(nth);
    this.dropZone = this.cropPdf.locator('#drop-zone');
    this.verbRow = this.cropPdf.locator('.verb-row').nth(0);
    ...
    this.verbImage = this.cropPdf.locator('.verb-image');
