export default class AddPdfNumberPage {
  constructor(page, nth = 0) {
    this.page = page;
    // compress-pdf widget locators
    this.section = this.page.locator('.section').nth(nth);
    this.addPdf = this.page.locator('.number-pages.unity-enabled').nth(nth);
    this.dropZone = this.addPdf.locator('#drop-zone');
    this.verbRow = this.addPdf.locator('.verb-row').nth(0);
    ...
    this.verbImage = this.addPdf.locator('.verb-image');
