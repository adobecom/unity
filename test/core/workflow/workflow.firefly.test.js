...
describe('Firefly Workflow Tests', () => {
  ...
  describe('UnityWidget Additional Tests', () => {
    ...
    it('should create prompt map correctly', () => {
      ...
      unityWidget.constructor.prototype.createPromptMap = function (data) {
        const promptMap = {};
  ...
  // ServiceHandler showErrorToast Tests
